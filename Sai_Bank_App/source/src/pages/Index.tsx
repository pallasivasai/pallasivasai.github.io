                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li className="flex items-center justify-between rounded-xl bg-black/20 px-3 py-2">
                      <div>
                        ...
                        <p className="text-xs text-white/70">You sent ₹ 18,500 to the wrong account, then reversed it within 30 minutes so the full amount came back to your balance.</p>
                      </div>
